...
rw_x = (x + 100) + lengthdir_x(80, pose.s2re); // R X
rw_y = (y - 50) + lengthdir_y(80, pose.s2re);  // R Y

// Left Wrist Calculations
lw_x = (x - 100) + lengthdir_x(80, pose.s2le); // L X
lw_y = (y - 50) + lengthdir_y(80, pose.s2le);  // L Y
